...
var file_newsdoc_newsdoc_proto_goTypes = []interface{}{
...
func file_newsdoc_newsdoc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_newsdoc_newsdoc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_newsdoc_newsdoc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Block); i {
			case 0:
				return &v.state
			case 1:
