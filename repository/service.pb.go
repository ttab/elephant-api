...
var file_repository_service_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x73, 0x22, 0xa8, 0x04, 0x0a, 0x0c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x6c, 0x6f, 0x67,
	...
	0x69, 0x6e, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0x26,
	...
	0x52, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x22, 0xd1, 0x04, 0x0a, 0x0c, 0x44, 0x6f, 0x63, 0x75, 0x6d,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x84, 0x02, 0x0a, 0x06, 0x53,
	...
	0x73, 0x65, 0x22, 0xac, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53,
	...
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x42, 0x79, 0x22, 0xcd, 0x01, 0x0a, 0x13, 0x43, 0x72,
	...
	0x75, 0x72, 0x6c, 0x2a, 0x3c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x6f,
	...
	0x09, 0x49, 0x4e, 0x43, 0x52, 0x45, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x02, 0x32, 0x95, 0x11, 0x0a,
...
var file_repository_service_proto_msgTypes = make([]protoimpl.MessageInfo, 146)
var file_repository_service_proto_goTypes = []any{
	...
	(*GetWithheldRequest)(nil),           // 127: elephant.repository.GetWithheldRequest
	(*GetWithheldResponse)(nil),          // 128: elephant.repository.GetWithheldResponse
	(*ScheduledDocument)(nil),            // 129: elephant.repository.ScheduledDocument
	...
	nil,                                  // 132: elephant.repository.GetNilStatusesResponse.StatusesEntry
	nil,                                  // 133: elephant.repository.StatusOverviewItem.HeadsEntry
	nil,                                  // 134: elephant.repository.GetPermissionsResponse.PermissionsEntry
	nil,                                  // 135: elephant.repository.DocumentVersion.MetaEntry
	nil,                                  // 136: elephant.repository.DocumentVersion.StatusesEntry
	nil,                                  // 137: elephant.repository.UpdateRequest.MetaEntry
	nil,                                  // 138: elephant.repository.UpdateRequest.IfStatusHeadsEntry
	nil,                                  // 139: elephant.repository.UpdateRequest.AttachObjectsEntry
	nil,                                  // 140: elephant.repository.StatusUpdate.MetaEntry
	nil,                                  // 141: elephant.repository.DeleteDocumentRequest.MetaEntry
	nil,                                  // 142: elephant.repository.DeleteRecord.MetaEntry
	nil,                                  // 143: elephant.repository.DocumentMeta.HeadsEntry
	nil,                                  // 144: elephant.repository.Status.MetaEntry
	nil,                                  // 145: elephant.repository.GetAllActiveSchemasRequest.KnownEntry
	nil,                                  // 146: elephant.repository.GetMetricsResponse.DocumentsEntry
	nil,                                  // 147: elephant.repository.CreateUploadRequest.MetaEntry
	(*newsdoc.Document)(nil),             // 148: newsdoc.Document
}
var file_repository_service_proto_depIdxs = []int32{
	...
	132, // 2: elephant.repository.GetNilStatusesResponse.statuses:type_name -> elephant.repository.GetNilStatusesResponse.StatusesEntry
	10,  // 3: elephant.repository.GetStatusOverviewResponse.items:type_name -> elephant.repository.StatusOverviewItem
	133, // 4: elephant.repository.StatusOverviewItem.heads:type_name -> elephant.repository.StatusOverviewItem.HeadsEntry
	134, // 5: elephant.repository.GetPermissionsResponse.permissions:type_name -> elephant.repository.GetPermissionsResponse.PermissionsEntry
	...
	148, // 21: elephant.repository.GetDocumentResponse.document:type_name -> newsdoc.Document
	...
	148, // 26: elephant.repository.BulkGetItem.document:type_name -> newsdoc.Document
	148, // 27: elephant.repository.MetaDocument.document:type_name -> newsdoc.Document
	62,  // 28: elephant.repository.GetHistoryResponse.versions:type_name -> elephant.repository.DocumentVersion
	135, // 29: elephant.repository.DocumentVersion.meta:type_name -> elephant.repository.DocumentVersion.MetaEntry
	136, // 30: elephant.repository.DocumentVersion.statuses:type_name -> elephant.repository.DocumentVersion.StatusesEntry
	88,  // 31: elephant.repository.DocumentStatuses.items:type_name -> elephant.repository.Status
	148, // 32: elephant.repository.UpdateRequest.document:type_name -> newsdoc.Document
	137, // 33: elephant.repository.UpdateRequest.meta:type_name -> elephant.repository.UpdateRequest.MetaEntry
	...
	138, // 37: elephant.repository.UpdateRequest.if_status_heads:type_name -> elephant.repository.UpdateRequest.IfStatusHeadsEntry
	139, // 38: elephant.repository.UpdateRequest.attach_objects:type_name -> elephant.repository.UpdateRequest.AttachObjectsEntry
	...
	148, // 41: elephant.repository.ValidateRequest.document:type_name -> newsdoc.Document
	...
	140, // 44: elephant.repository.StatusUpdate.meta:type_name -> elephant.repository.StatusUpdate.MetaEntry
	89,  // 45: elephant.repository.UpdatePermissionsRequest.list:type_name -> elephant.repository.ACLEntry
	141, // 46: elephant.repository.DeleteDocumentRequest.meta:type_name -> elephant.repository.DeleteDocumentRequest.MetaEntry
	89,  // 47: elephant.repository.RestoreRequest.acl:type_name -> elephant.repository.ACLEntry
	84,  // 48: elephant.repository.ListDeletedResponse.deletes:type_name -> elephant.repository.DeleteRecord
	142, // 49: elephant.repository.DeleteRecord.meta:type_name -> elephant.repository.DeleteRecord.MetaEntry
	87,  // 50: elephant.repository.GetMetaResponse.meta:type_name -> elephant.repository.DocumentMeta
	143, // 51: elephant.repository.DocumentMeta.heads:type_name -> elephant.repository.DocumentMeta.HeadsEntry
	89,  // 52: elephant.repository.DocumentMeta.acl:type_name -> elephant.repository.ACLEntry
	90,  // 53: elephant.repository.DocumentMeta.lock:type_name -> elephant.repository.Lock
	144, // 54: elephant.repository.Status.meta:type_name -> elephant.repository.Status.MetaEntry
	103, // 55: elephant.repository.RegisterSchemaRequest.schema:type_name -> elephant.repository.Schema
	145, // 56: elephant.repository.GetAllActiveSchemasRequest.known:type_name -> elephant.repository.GetAllActiveSchemasRequest.KnownEntry
	103, // 57: elephant.repository.GetAllActiveSchemasResponse.schemas:type_name -> elephant.repository.Schema
	105, // 58: elephant.repository.GetDeprecationsResponse.deprecations:type_name -> elephant.repository.Deprecation
	105, // 59: elephant.repository.UpdateDeprecationRequest.deprecation:type_name -> elephant.repository.Deprecation
	1,   // 60: elephant.repository.RegisterMetricKindRequest.aggregation:type_name -> elephant.repository.MetricAggregation
	115, // 61: elephant.repository.GetMetricKindsResponse.kinds:type_name -> elephant.repository.MetricKind
	1,   // 62: elephant.repository.MetricKind.aggregation:type_name -> elephant.repository.MetricAggregation
	146, // 63: elephant.repository.GetMetricsResponse.documents:type_name -> elephant.repository.GetMetricsResponse.DocumentsEntry
	121, // 64: elephant.repository.DocumentMetrics.metrics:type_name -> elephant.repository.Metric
	129, // 65: elephant.repository.GetWithheldResponse.items:type_name -> elephant.repository.ScheduledDocument
	147, // 66: elephant.repository.CreateUploadRequest.meta:type_name -> elephant.repository.CreateUploadRequest.MetaEntry
	63,  // 67: elephant.repository.GetNilStatusesResponse.StatusesEntry.value:type_name -> elephant.repository.DocumentStatuses
	88,  // 68: elephant.repository.StatusOverviewItem.HeadsEntry.value:type_name -> elephant.repository.Status
	63,  // 69: elephant.repository.DocumentVersion.StatusesEntry.value:type_name -> elephant.repository.DocumentStatuses
	88,  // 70: elephant.repository.DocumentMeta.HeadsEntry.value:type_name -> elephant.repository.Status
	120, // 71: elephant.repository.GetMetricsResponse.DocumentsEntry.value:type_name -> elephant.repository.DocumentMetrics
	53,  // 72: elephant.repository.Documents.Get:input_type -> elephant.repository.GetDocumentRequest
	55,  // 73: elephant.repository.Documents.BulkGet:input_type -> elephant.repository.BulkGetRequest
	60,  // 74: elephant.repository.Documents.GetHistory:input_type -> elephant.repository.GetHistoryRequest
	64,  // 75: elephant.repository.Documents.Update:input_type -> elephant.repository.UpdateRequest
	67,  // 76: elephant.repository.Documents.BulkUpdate:input_type -> elephant.repository.BulkUpdateRequest
	69,  // 77: elephant.repository.Documents.Validate:input_type -> elephant.repository.ValidateRequest
	76,  // 78: elephant.repository.Documents.Delete:input_type -> elephant.repository.DeleteDocumentRequest
	82,  // 79: elephant.repository.Documents.ListDeleted:input_type -> elephant.repository.ListDeletedRequest
	78,  // 80: elephant.repository.Documents.Restore:input_type -> elephant.repository.RestoreRequest
	80,  // 81: elephant.repository.Documents.Purge:input_type -> elephant.repository.PurgeRequest
	85,  // 82: elephant.repository.Documents.GetMeta:input_type -> elephant.repository.GetMetaRequest
	...
	122, // 90: elephant.repository.Documents.Lock:input_type -> elephant.repository.LockRequest
	124, // 91: elephant.repository.Documents.ExtendLock:input_type -> elephant.repository.ExtendLockRequest
	125, // 92: elephant.repository.Documents.Unlock:input_type -> elephant.repository.UnlockRequest
	127, // 93: elephant.repository.Documents.GetWithheld:input_type -> elephant.repository.GetWithheldRequest
	130, // 94: elephant.repository.Documents.CreateUpload:input_type -> elephant.repository.CreateUploadRequest
	95,  // 95: elephant.repository.Schemas.Register:input_type -> elephant.repository.RegisterSchemaRequest
	97,  // 96: elephant.repository.Schemas.SetActive:input_type -> elephant.repository.SetActiveSchemaRequest
	99,  // 97: elephant.repository.Schemas.Get:input_type -> elephant.repository.GetSchemaRequest
	101, // 98: elephant.repository.Schemas.GetAllActive:input_type -> elephant.repository.GetAllActiveSchemasRequest
	91,  // 99: elephant.repository.Schemas.RegisterMetaType:input_type -> elephant.repository.RegisterMetaTypeRequest
	93,  // 100: elephant.repository.Schemas.RegisterMetaTypeUse:input_type -> elephant.repository.RegisterMetaTypeUseRequest
	104, // 101: elephant.repository.Schemas.GetDeprecations:input_type -> elephant.repository.GetDeprecationsRequest
	107, // 102: elephant.repository.Schemas.UpdateDeprecation:input_type -> elephant.repository.UpdateDeprecationRequest
	46,  // 103: elephant.repository.Workflows.UpdateStatus:input_type -> elephant.repository.UpdateStatusRequest
	36,  // 104: elephant.repository.Workflows.GetStatuses:input_type -> elephant.repository.GetStatusesRequest
	48,  // 105: elephant.repository.Workflows.CreateStatusRule:input_type -> elephant.repository.CreateStatusRuleRequest
	51,  // 106: elephant.repository.Workflows.DeleteStatusRule:input_type -> elephant.repository.DeleteStatusRuleRequest
	34,  // 107: elephant.repository.Workflows.GetStatusRules:input_type -> elephant.repository.GetStatusRulesRequest
	37,  // 108: elephant.repository.Workflows.SetWorkflow:input_type -> elephant.repository.SetWorkflowRequest
	40,  // 109: elephant.repository.Workflows.GetWorkflow:input_type -> elephant.repository.GetWorkflowRequest
	42,  // 110: elephant.repository.Workflows.DeleteWorkflow:input_type -> elephant.repository.DeleteWorkflowRequest
	27,  // 111: elephant.repository.Reports.List:input_type -> elephant.repository.ListReportsRequest
	26,  // 112: elephant.repository.Reports.Update:input_type -> elephant.repository.UpdateReportRequest
	24,  // 113: elephant.repository.Reports.Get:input_type -> elephant.repository.GetReportRequest
	22,  // 114: elephant.repository.Reports.Delete:input_type -> elephant.repository.DeleteReportRequest
	18,  // 115: elephant.repository.Reports.Run:input_type -> elephant.repository.RunReportRequest
	20,  // 116: elephant.repository.Reports.Test:input_type -> elephant.repository.TestReportRequest
	109, // 117: elephant.repository.Metrics.RegisterKind:input_type -> elephant.repository.RegisterMetricKindRequest
	111, // 118: elephant.repository.Metrics.DeleteKind:input_type -> elephant.repository.DeleteMetricKindRequest
	113, // 119: elephant.repository.Metrics.GetKinds:input_type -> elephant.repository.GetMetricKindsRequest
	116, // 120: elephant.repository.Metrics.RegisterMetric:input_type -> elephant.repository.RegisterMetricRequest
	118, // 121: elephant.repository.Metrics.GetMetrics:input_type -> elephant.repository.GetMetricsRequest
	54,  // 122: elephant.repository.Documents.Get:output_type -> elephant.repository.GetDocumentResponse
	57,  // 123: elephant.repository.Documents.BulkGet:output_type -> elephant.repository.BulkGetResponse
	61,  // 124: elephant.repository.Documents.GetHistory:output_type -> elephant.repository.GetHistoryResponse
	66,  // 125: elephant.repository.Documents.Update:output_type -> elephant.repository.UpdateResponse
	68,  // 126: elephant.repository.Documents.BulkUpdate:output_type -> elephant.repository.BulkUpdateResponse
	70,  // 127: elephant.repository.Documents.Validate:output_type -> elephant.repository.ValidateResponse
	77,  // 128: elephant.repository.Documents.Delete:output_type -> elephant.repository.DeleteDocumentResponse
	83,  // 129: elephant.repository.Documents.ListDeleted:output_type -> elephant.repository.ListDeletedResponse
	79,  // 130: elephant.repository.Documents.Restore:output_type -> elephant.repository.RestoreResponse
	81,  // 131: elephant.repository.Documents.Purge:output_type -> elephant.repository.PurgeResponse
	86,  // 132: elephant.repository.Documents.GetMeta:output_type -> elephant.repository.GetMetaResponse
	14,  // 133: elephant.repository.Documents.Eventlog:output_type -> elephant.repository.GetEventlogResponse
	16,  // 134: elephant.repository.Documents.CompactedEventlog:output_type -> elephant.repository.GetCompactedEventlogResponse
	3,   // 135: elephant.repository.Documents.GetStatus:output_type -> elephant.repository.GetStatusResponse
	5,   // 136: elephant.repository.Documents.GetStatusHistory:output_type -> elephant.repository.GetStatusHistoryReponse
	7,   // 137: elephant.repository.Documents.GetNilStatuses:output_type -> elephant.repository.GetNilStatusesResponse
	9,   // 138: elephant.repository.Documents.GetStatusOverview:output_type -> elephant.repository.GetStatusOverviewResponse
	12,  // 139: elephant.repository.Documents.GetPermissions:output_type -> elephant.repository.GetPermissionsResponse
	123, // 140: elephant.repository.Documents.Lock:output_type -> elephant.repository.LockResponse
	123, // 141: elephant.repository.Documents.ExtendLock:output_type -> elephant.repository.LockResponse
	126, // 142: elephant.repository.Documents.Unlock:output_type -> elephant.repository.UnlockResponse
	128, // 143: elephant.repository.Documents.GetWithheld:output_type -> elephant.repository.GetWithheldResponse
	131, // 144: elephant.repository.Documents.CreateUpload:output_type -> elephant.repository.CreateUploadResponse
	96,  // 145: elephant.repository.Schemas.Register:output_type -> elephant.repository.RegisterSchemaResponse
	98,  // 146: elephant.repository.Schemas.SetActive:output_type -> elephant.repository.SetActiveSchemaResponse
	100, // 147: elephant.repository.Schemas.Get:output_type -> elephant.repository.GetSchemaResponse
	102, // 148: elephant.repository.Schemas.GetAllActive:output_type -> elephant.repository.GetAllActiveSchemasResponse
	92,  // 149: elephant.repository.Schemas.RegisterMetaType:output_type -> elephant.repository.RegisterMetaTypeResponse
	94,  // 150: elephant.repository.Schemas.RegisterMetaTypeUse:output_type -> elephant.repository.RegisterMetaTypeUseResponse
	106, // 151: elephant.repository.Schemas.GetDeprecations:output_type -> elephant.repository.GetDeprecationsResponse
	108, // 152: elephant.repository.Schemas.UpdateDeprecation:output_type -> elephant.repository.UpdateDeprecationResponse
	47,  // 153: elephant.repository.Workflows.UpdateStatus:output_type -> elephant.repository.UpdateStatusResponse
	45,  // 154: elephant.repository.Workflows.GetStatuses:output_type -> elephant.repository.GetStatusesResponse
	50,  // 155: elephant.repository.Workflows.CreateStatusRule:output_type -> elephant.repository.CreateStatusRuleResponse
	52,  // 156: elephant.repository.Workflows.DeleteStatusRule:output_type -> elephant.repository.DeleteStatusRuleResponse
	35,  // 157: elephant.repository.Workflows.GetStatusRules:output_type -> elephant.repository.GetStatusRulesResponse
	39,  // 158: elephant.repository.Workflows.SetWorkflow:output_type -> elephant.repository.SetWorkflowResponse
	41,  // 159: elephant.repository.Workflows.GetWorkflow:output_type -> elephant.repository.GetWorkflowResponse
	43,  // 160: elephant.repository.Workflows.DeleteWorkflow:output_type -> elephant.repository.DeleteWorkflowResponse
	28,  // 161: elephant.repository.Reports.List:output_type -> elephant.repository.ListReportsResponse
	33,  // 162: elephant.repository.Reports.Update:output_type -> elephant.repository.UpdateReportResponse
	25,  // 163: elephant.repository.Reports.Get:output_type -> elephant.repository.GetReportResponse
	23,  // 164: elephant.repository.Reports.Delete:output_type -> elephant.repository.DeleteReportResponse
	19,  // 165: elephant.repository.Reports.Run:output_type -> elephant.repository.RunReportResponse
	21,  // 166: elephant.repository.Reports.Test:output_type -> elephant.repository.TestReportResponse
	110, // 167: elephant.repository.Metrics.RegisterKind:output_type -> elephant.repository.RegisterMetricKindResponse
	112, // 168: elephant.repository.Metrics.DeleteKind:output_type -> elephant.repository.DeleteMetricKindResponse
	114, // 169: elephant.repository.Metrics.GetKinds:output_type -> elephant.repository.GetMetricKindsResponse
	117, // 170: elephant.repository.Metrics.RegisterMetric:output_type -> elephant.repository.RegisterMetricResponse
	119, // 171: elephant.repository.Metrics.GetMetrics:output_type -> elephant.repository.GetMetricsResponse
